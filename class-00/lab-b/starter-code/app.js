...
// 'this' in arrow functions don't get redefined and will be in the same scope where the function is defined, 'this' in normal functions gets redefined based on the calling scope.